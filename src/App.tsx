 ...
 * replaced by a second synthetic waveform calculation — the clip preview shows
 * verbatim Rekordbox data, never a re-analysis. */
...
export default function App() {  // Project state - Stringent Empty Project (Master Prompt & Voice Directive)
  ...
  // dropTime lets drag & drop place the clip at the pointer position;
  // button-based insert keeps the playhead position (default).
