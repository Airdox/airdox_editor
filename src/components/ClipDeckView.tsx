              ...
              clips.map((clip) => {
                ...
                return (
                  <div
                    ...
                    className={`p-1.5 rounded-xs border transition-all flex items-center justify-between ${clip.audioBuffer ? 'cursor-grab active:cursor-grabbing' : 'cursor-not-allowed opacity-60'} ${
                      isSelected
